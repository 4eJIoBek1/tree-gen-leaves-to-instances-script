...
To use the script, open it in "text" menu in blender, select leaves/blossom mesh/meshes you need and run script by pressing that "play" button on the top of menu.
